...
/**
 * A hash class for common hash encryption.
 * the md5() function is totally equivalent to php md5().
 * you can use online tools to compare the result.
 * @author riguz
 *
 */
public final class Hashs {
    ...
    /**
     * MD5 32 byte hash
     * md5(hello,32) = 5d41402abc4b2a76b9719d911017c592
    ...
    /**
     * MD5 16 byte hash. it's the middle part of MD5-32 byte result
     * md5(hello,16) = bc4b2a76b9719d91
     * @param plainText source to encrypt
     * @return encrypted string, or null if failed
     */
